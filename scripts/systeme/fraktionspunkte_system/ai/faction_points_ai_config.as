...
const string FP_AI_SPARE_TOKENS_4 = "event7";
const string FP_AI_SPARE_TOKENS_5 = "save";
...
const float FP_AI_SPARE_WEIGHTS_4 = 0.4f;
const float FP_AI_SPARE_WEIGHTS_5 = 0.3f;
