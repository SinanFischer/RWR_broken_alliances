...
- Konkret:
  ...
  - Shotgun/CQB (Origin-12, TTI, Sabre, Bogen): **≤ 0.01** (Vanilla Mossberg/SPAS = 0.01) → z. B. **0.005** oder **0.01**.
...
- **Tier 2 – Spezialisten (0.1 / 0.05 / 0.01):**
  ...
  - **0.01** für CQB/Shotgun/Schild/Utility: origin_12, origin_12_s (Shotgun), tti (Schild+CQB), camo_shield (Schild), sabre (Melee), compound_bow, compound_bow_alt (Bogen), taser_medic (Heilen), fhj01 (FAE Utility). Schrotflinten und CQB strikt 0.01.
...
| sabre | all | cqb | 2 | 0.01 | 333 | Melee-Elite; CQB-Tag, selten spawnen. |
| m16a4_support | USA | assault | 2 | 0.1 | 90 | AR+Schild Spezialist; LMG/DMR-Level Spawnrate. |
| sbl | RU | bazooka* | 4 | 0.0001 | 300 | Kreissägen Elite; *Tag ergänzen (aktuell nur denied_in_penalty). |
...
- **SBL:** In `sbl.weapon` zusätzlich `<tag name="bazooka" />` setzen, falls KI-Spawn gewünscht; sonst commonness 0 belassen.
